...
with open('C:/Users/littl/Code/GitHub/ArcticFoxExamples/PandasExamples/.af/analyzedvariables/columnadd.analyzedvariables.json', 'r') as _af_dataSave:
...
def analyzeVariables(variables):
    for (variableName, variableValue) in variables:
        ...
        _af_arcticFoxDataDictionary[r'PandasExamples_ColumnAdd.py']['variables'][variableName]['type'] = 'None'
        ...
        _af_arcticFoxDataDictionary[r'PandasExamples_ColumnAdd.py']['variables'][variableName]['type'] = variableType
        ...
        if isinstance(variableValue, pd.DataFrame):
            ...
            _af_arcticFoxDataDictionary[r'PandasExamples_ColumnAdd.py']['variables'][variableName]['columns'] = dataColumns
...
def saveAnalyzedVariables():
    with open('C:/Users/littl/Code/GitHub/ArcticFoxExamples/PandasExamples/.af/analyzedvariables/columnadd.analyzedvariables.json', 'w') as _af_dataSave:
