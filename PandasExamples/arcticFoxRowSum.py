...
with open('C:/Users/littl/Code/GitHub/ArcticFoxExamples/PandasExamples/.af/analyzedvariables/rowsum.analyzedvariables.json', 'r') as _af_dataSave:
...
def analyzeVariables(variables):
    for (variableName, variableValue) in variables:
        ...
        _af_arcticFoxDataDictionary[r'PandasExamples_RowSum.py']['variables'][variableName]['type'] = 'None'
        ...
        _af_arcticFoxDataDictionary[r'PandasExamples_RowSum.py']['variables'][variableName]['type'] = variableType
...
def saveAnalyzedVariables():
    with open('C:/Users/littl/Code/GitHub/ArcticFoxExamples/PandasExamples/.af/analyzedvariables/rowsum.analyzedvariables.json', 'w') as _af_dataSave:
