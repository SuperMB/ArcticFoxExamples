...
with open('C:/Users/littl/Code/GitHub/ArcticFoxExamples/PandasExamples/.af/analyzedvariables/rowduplicates.analyzedvariables.json', 'r') as _af_dataSave:
...
def analyzeVariables(variables):
    for (variableName, variableValue) in variables:
        ...
        _af_arcticFoxDataDictionary[r'PandasExamples_RowDuplicates.py']['variables'][variableName]['type'] = 'None'
        ...
        _af_arcticFoxDataDictionary[r'PandasExamples_RowDuplicates.py']['variables'][variableName]['type'] = variableType
        _af_arcticFoxDataDictionary[r'PandasExamples_RowDuplicates.py']['variables'][variableName]['type'] = 'None'
        variableType = str(type(variableValue))
        if variableType.startswith("<class '") and variableType.endswith("'>"):
            variableType = variableType.replace("<class '", "")
        ...
        if isinstance(variableValue, pd.DataFrame):
            ...
            _af_arcticFoxDataDictionary[r'PandasExamples_RowDuplicates.py']['variables'][variableName]['columns'] = dataColumns
...
def saveAnalyzedVariables():
    with open('C:/Users/littl/Code/GitHub/ArcticFoxExamples/PandasExamples/.af/analyzedvariables/rowduplicates.analyzedvariables.json', 'w') as _af_dataSave:
