...
#> Scatter --x FG_Percent --y Points --exampleImage Scatter1.png --exampleTitle Scatter Plot of Numerical Columns --example A basic scatter plot showing how many points each player scored relative to their field goal percentage. This type of chart visualizes whether more efficient shooters tend to score more points overall.
...
#> Scatter --x Team --y Age --exampleImage Scatter2.png --exampleTitle Scatter Plot of Numerical vs Categorical Columns --example This scatter plot compares the age of each player by their team. The x-axis shows each team labels, while the y-axis shows player age. This examples identifies age distribution across teams.
...
#> Scatter Points --exampleImage Scatter3.png --exampleTitle Scatter Plot by Index --example In this example, we visualize the Points column directly against its index. This creates a simple trend view of scoring across the dataset making it easy to see data across a single column.
