...
#> BoxPlot --exampleImage Box1.png --exampleTitle Create Boxplots of All Numeric Columns --example Use a boxplot to quickly understand the distribution of each numeric column in the dataframe. This example automatically creates a single boxplot for each numeric column, all plotted together on one figure for easy comparison.
xTickIndex = 0
